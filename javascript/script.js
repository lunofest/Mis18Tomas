...
function updateTimer() {
  const targetDate = new Date("january 17, 2025 21:00:00").getTime();
...
document.addEventListener('DOMContentLoaded', function() {
  ...
  const phoneNumber1 = '541151187664'; // Número para el primer botón
...
document.addEventListener('DOMContentLoaded', function() {
  // Definir los números de teléfono
  const recipientNumber1 = '541151154493'; // Número para el primer botón
  const recipientNumber2 = '543865749563'; // Número para el segundo botón
  const recipientNumber3 = '543865826987'; // Número para el tercer botón (actualízalo con el número deseado)
